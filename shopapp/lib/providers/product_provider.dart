...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProduct([bool filterByUser = false]) async {
    ...
    var url = Uri.parse(
        'https://shop-app-4b081-default-rtdb.firebaseio.com/products.json?auth=$authtoken&$filterString');
    try {
      ...
      url = Uri.parse(
          'https://shop-app-4b081-default-rtdb.firebaseio.com/userFav/$userId.json?auth=$authtoken');
  ...
  Future<void> deleteProduct_(String id) async {
    ...
    if (response.statusCode >= 400) {
      items_.insert(existingProductIndex, existingProduct as Product);
      notifyListeners();
